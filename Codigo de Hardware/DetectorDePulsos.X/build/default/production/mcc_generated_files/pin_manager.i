...
# 364 "mcc_generated_files/tmr0.h"
int contarTiempo(void);
...
int obtenerTipoPulso(int *contDePulsos){
        ...
        else if(*contDePulsos >= (50 -1) && *contDePulsos <= (50 +1)){
            tipoDeSenal = 1;
            return tipoDeSenal;
        }
        else if(*contDePulsos >= (75 -1) && *contDePulsos <= (75 +1)){
            tipoDeSenal = 2;
            return tipoDeSenal;
        }
        else if(*contDePulsos >= (100 -1) && *contDePulsos <= (100 +1)){
            tipoDeSenal = 3;
            return tipoDeSenal;
        }
        else if(*contDePulsos >= (150 -1) && *contDePulsos <= (150 +1)){
            tipoDeSenal = 4;
            return tipoDeSenal;
        }
        else if(*contDePulsos >= (200 -2) && *contDePulsos <= (200 +2)){
            tipoDeSenal = 5;
            return tipoDeSenal;
        }
        else{
